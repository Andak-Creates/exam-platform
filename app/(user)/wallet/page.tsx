...
import { FaArrowRight, FaMoneyBills, FaNairaSign } from "react-icons/fa6";
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-[#61616141]">
                        ...
                        <th className="text-left py-3 text-[#aaa] font-medium text-[14px] hidden md:flex">
                          Type
                        </th>
                        <th className="text-left py-3 text-[#aaa] font-medium text-[14px]">
                          Amount
                    ...
                    <tbody>
                      {filteredTransactions.map((transaction) => (
                        ...
                        >
                          ...
                          <td className="py-4 text-[14px] capitalize hidden md:flex">
                            {transaction.type}
                          </td>
                          <td
                          ...
                          <td className="py-4 text-[14px]">
                            <span
                              className={`px-3 py-1 rounded-full text-[10px] hidden md:flex ${
          ...
          <div className="w-full md:w-[35%] flex-1 flex justify-between flex-col">
            ...
            <div className="bg-[#ffffff10] border border-[#ffffff20] rounded-3xl shadow-lg w-full p-5 ">
              ...
              <div className="mt-3 w-full">
                <p className="uppercase text-[14px]">
                  Digibyte Deposit address
                </p>
                <div className="mt-1 relative border py-1 px-2 w-full overflow-hidden rounded-full">
                  <p className="pr-10 text-sm break-all">
                    dehejhsyshufuf74u4i4k00fineugg
                  </p>
                  <div className="absolute right-0 px-2 bg-white top-0 w-fit h-full flex items-center justify-center cursor-pointer">
                    <FaCopy color="black" />
                  </div>
                </div>
              </div>
              ...
              <div className="mt-3 rounded-lg text-[#8B1E1E] bg-[#FFF7ED] p-3 flex flex-row gap-2 items-start">
                ...
                <p className="text-[14px]">
                  Send only{" "}
                  <span className="font-semibold">Digibyte (DGB)</span> to this
            ...
            <div className="bg-linear-to-r from-[#8B1E1E] to-[#250808] rounded-3xl p-5 mt-5 border border-[#aaa] h-full flex flex-col justify-center">
              <h3 className="font-semibold text-[20px]">
                Win Big In Olympiads!
              </h3>
              <p className="mt-2">
                Top 3 scorers in the Monthly Math Challenge win prize pool
                shares.
              </p>
              <Link
                href="/exams"
